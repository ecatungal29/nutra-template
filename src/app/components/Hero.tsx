  ...
  return (
    <>
      <div className="bg-gradient-to-r from-[#25283b] via-[#3e3f67] to-[#2a2b46] md:overflow-hidden pt-8 pb-51">
        <h2 className='text-2xl md:text-4xl text-[#bac2d7] font-semibold text-center'>
          Harvard:
        </h2>

        <div className="w-10/12 md:w-6/12 mx-auto">
          <h1 className='headline text-[#bac2d7] font-bold text-center mb-8'>
            You have 14 Days to Fix Enlarged Prostate, Or it&apos;s Too Late
          </h1>
        </div>
