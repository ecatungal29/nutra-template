    ...
    return (
        <>
            <div className="bg-gradient-to-r from-[#25283b] via-[#3e3f67] to-[#2a2b46] md:overflow-hidden pt-8 pb-51">
                <h1 className="text-xl md:text-3xl  lg:text-5xl text-[#ffffff] font-semibold text-center mx-1 ">
                    Harvard:You have 14 Days to Fix
                </h1>

                <div className="w-10/12 md:w-6/12 mx-auto">
                    <h1 className=" text-xl md:text-3xl lg:text-5xl text-[#ffffff] font-bold text-center mb-3">
