                                    ...
                                    <div className="bg-white">
                                        <div className="bg-gray-200 p-5">
                                            ...
                                            <p className="text-center mt-2 text-lg">
                                                You qualify to get 1 Free bottle
                                                when you purchase just 2 bottles
                                                of ProstaFlow
                                            </p>
                                        </div>
                                        ...
                                        <p className="text-center text-lg font-bold">
                                            *In order to see real lasting
                                            results, I highly recommend you grab
                                            at least 2 bootles.
                                        </p>
                                        <div className="w-full flex m-2 mx-auto p-5">
                                            <Link
                                                href="/"
                                                className="w-full text-black bg-yellow-300 hover:bg-yellow-400 font-semibold rounded-full text-2xl px-5 py-3 text-center"
                                            >
                                        ...
                                        <p
                                            ...
                                            className="hover:cursor-pointer text-center text-base text-gray-600 underline"
                                        >
                                            No Thanks, I Don&apos;t want to this
                                            upgrade!
                                        </p>
                                    </div>
                                </div>
