  ...
  return (
    <>
      <div className='w-10/12 md:w-9/12 mx-auto'>
        <h1 className='text-center font-bold text-4xl mt-10 mb-5'>How To Contact Us</h1>

        <div className='w-full md:w-8/12 mx-auto'>
          <p className='text-center'>Do you have any questions? Please do not hesitate to contact us directly.
        ...
        <div className="w-9/12 mx-auto">
          <p className='text-sm mt-4'>* Every email call is managed by our friendly customer support agents, and they will reply as soon as possible.</p>
        </div>
        ...
        <div className="w-10/12 mx-auto px-4 md:px-6 py-24">
          <h1 className=" text-3xl md:text-4xl font-bold text-slate-900 mb-4 text-center">Frequently Asked Questions</h1>
          <div className="divide-y divide-slate-200">
            {faqs.map((faq, index) => (
              <Questions key={index} title={faq.title} id={`faqs-${index}`} active={faq.active}>
                {faq.text}
              </Questions>
            ))}
          </div>
