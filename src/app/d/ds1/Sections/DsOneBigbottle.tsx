                ...
                <div className="w-full">
                    ...
                    <div className="w-11/12 mx-auto p-3 ">
                        <p
                            ...
                            className=" hover:cursor-pointer hover:text-blue-600 text-sm underline text-center justify-center text-gray-500 lg:mx-6 mb-6"
                        >
