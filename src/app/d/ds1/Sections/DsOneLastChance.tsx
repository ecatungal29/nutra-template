...
export default function DsOneLastChance() {
    return (
        <>
                ...
                <div className="p-10 md:p-0 items-center bg-gradient-to-t from-[#384364] to-[#29314A] border rounded-[40px] md:w-11/12 lg:w-9/12 max-w-screen-lg">
                    <div className="md:p-8 md:w-10/12 mx-auto">
                        <h1 className="text-center mb-2 font-semibold text-white text-xl md:text-2xl">
                            On This &quot;Last Chance&quot; Page, You Get 2 More
                        ...
                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            When you click the &apos;YES! GIVE ME HUGE
                            SAVINGS&apos; button below, you get our most insane
                            discount (2 extra bottles of ProstaFlow for only $29
                            per bottle)...
                        </p>

                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            You also get the 2 digital bonuses.
                        </p>

                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            You can access your 2 digital bonuses immediately on
                            your computer, smartphone or tablet, while your
                            order of ProstaFlow is being sent to you.
                        </p>
                    </div>
                </div>
            </div>
