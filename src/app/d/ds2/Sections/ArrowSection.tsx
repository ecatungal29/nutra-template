    ...
    return (
        <>
            <div className="mx-auto flex justify-center mt-5">
                <a
                    href="#"
                    className="w-11/12 md:w-9/12 mx-auto p-10 items-center  rounded-3xl bg-gradient-to-t from-[#544080] to-[#26144d]"
                >
                    ...
                    <div className="flex justify-center -mb-20">
                        <div className=" border-white border-[8px] rounded-full m-0">
                            <Image
                                ...
                                className="md:w-[100px] w-[50px] h-[50px] md:h-[100px]  m-0"
                                width={1500}
                                height={1500}
                                priority
                                alt="..."
