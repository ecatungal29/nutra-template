    ...
    <>
      ...
      <div className='mx-auto flex justify-center'>
        <a href="#" className="flex flex-col items-center bg-[#26144d] border rounded-lg shadow md:flex-row md:w-9/12 p-5 hover:bg-[#1f0f42]">
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            <h5 className="text-center md:text-left text-2xl font-bold tracking-tight text-white">&quot;Your Roadmap to Proactive Urological Care&quot; PDF Guide</h5>
      ...
      <div className='mx-auto flex justify-center mt-4'>
        <a href="#" className="flex flex-col items-center bg-[#26144d] border rounded-lg shadow md:flex-row md:w-9/12 p-5 hover:bg-[#1f0f42]">
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            <h5 className="text-center md:text-left text-2xl font-bold tracking-tight text-white">&ldquo;Unlocking Longevity&ldquo; PDF Guide</h5>
            <p className="text-center md:text-left mb-2 font-normal text-gray-300">In this bonus, you&apos;ll discover the keys to living a longer, healthier life with &apos;Unlocking Longevity.&apos; This insightful book delves into the science and strategies behind extending lifespan and enhancing overall well-being, offering practical tips and wisdom for unlocking your full potential.</p>
            <p className="text-center md:text-left mb-3 font-normal text-gray-400">* This image represents a digital download</p>
          </div>
        </a>
      </div>
