          ...
          <>
            ...
            <section className="bg-gray-200 pb-10">
              <div className='md:w-8/12 mx-auto pt-5'>
                {/* Show on desktop */}
                <h1 className='hidden lg:block headline font-bold text-center p-5'>
                  Claim your Discounted ProstaFlow Below While Stock Lasts
                </h1>

                {/* Show on mobile */}
                <h1 className='lg:hidden block headline font-bold text-center p-5'>
                  Claim your Discounted<br /> ProstaFlow Below<br /> While Stock Lasts
                </h1>
              </div>
            ...
            <div className='lg:w-9/12 mx-auto mt-10 md:mt-28 mb-5'>
              <h1 className='headline font-bold text-center px-5'>
                Take advantage of this limited offer to stock up on ProstaFlow while supplies last!
              </h1>
            </div>
