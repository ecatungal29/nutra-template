        ...
        <>
            <div className="w-10/12 md:w-9/12 mx-auto">
                ...
                <p className="mt-5">
                    ...
                    Privacy Policy applies to this website (hereinafter,
                    &quot;us&quot; or &quot;we&quot;).
                </p>
                <p className="mt-5">
                ...
                <p className="mt-5">
                    ...
                    policies governing your use of our Website.
                </p>
                <p className="mt-5">
                    Depending on your activities when visiting our Website, you
                ...
                <p className="mt-5">
                    ...
                    on trends in the usage of our website.
                </p>
                <p className="mt-5">
                    We also collect potentially personally-identifying
                    information like Internet Protocol (IP) addresses for logged
                    in users and for users leaving comments on blog posts.
                </p>
                <p className="mt-5">
                    We only disclose logged in user and commenter IP addresses
                ...
                <p className="mt-5">
                    Certain visitors to this website choose to interact in ways
                    that require us to gather personally-identifying
                    information. The amount and type of information that we
                    gather depends on the nature of the interaction. For
                    example, we ask visitors who sign up for a newsletter to
                ...
                <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                    ...
                    <li>
                        Express any concerns you might have about our use of
                        your data.
                    </li>
                </ul>
                ...
                <p className="mt-5">
                    ...
                    you. This Privacy Policy covers the use of cookies by our
                    website and does not cover the use of cookies by any
                    advertisers.
                </p>
                ...
                <p className="mt-5">
                    ...
                    visitors to our site. It could mean that we advertise to
                    previous visitors who may not have completed a task on our
                    site, for example using the contact form to make an enquiry.
                    This could be in the form of an advertisement on search
                    results pages, or a site in the Display Network.
                </p>
                <p className="mt-5">
                    Third-party vendors, including Google and Facebook, use
                    cookies to serve ads based on someone&apos;s past visits. Of
                    course, any data collected will be used in accordance with
                    our own privacy policy and the ad network&apos;s privacy
                    policy.
                </p>

                <p className="mt-5">
                    You can opt out of remarketing or interest-based advertising
                    entirely by cookie settings or permanently using a browser
                    plugin.
                </p>
                ...
                <p className="mt-5">
                    ...
                    behalf or to provide services available on our website, and
                ...
                <p className="mt-5">
                    ...
                    by using our website, you consent to the transfer of such
                    information to them.
                </p>

                <p className="mt-5">
                    We will not rent or sell potentially personally-identifying
                    and personally-identifying information to anyone.
                </p>
                ...
                <p className="mt-5">
                    ...
                    other governmental request, or when we believe in good faith
                    that disclosure is reasonably necessary to protect the
                    property or rights of our website, third parties or the
                    public at large.
                </p>

                <p className="mt-5">
                    If you are a registered user of our website and/or have
                    supplied your email address, we may occasionally send you an
                    email to tell you about new features, solicit your feedback,
                    or just keep you up to date with what&apos;s going on with
                    our website and our products. We primarily use our blog to
                ...
                <p className="mt-5">
                    When the user registers on our website to purchase the
                    products or services, they provide us with the email address
                    and automatically agree to receive notifications of
                    advertising, products, offers, services. You can change your
                    marketing preferences or remove yourself from our mailing
                    lists by clicking the &quot;unsubscribe&quot; link in the
                    footer of promotional emails, sending an email to
                    support@@getprostaflow.com. Sometimes it takes time for our
                    system to completely remove it from the database, so we
                    invite you to wait a reasonable time, in which you may
                    receive service-related announcements.
                </p>
                <p className="mt-5">
                ...
                <p className="mt-5">
                    We may collect statistics about the behaviour of visitors to
                ...
                <p className="mt-5">
                    ...
                    certain links. This does not affect your purchases or the
                    price you may pay.
                </p>
                ...
                <p className="mt-5">
                    ...
                    &quot;Cookies&quot;, similar technologies and services
                ...
                <p className="mt-5">
                    ...
                    returns. We use cookies to help is identify and track
                    visitors, their usage of this website and their website
                    access preferences. Visitors who do not wish to have cookies
                    placed on their computers should set their browsers to
                    refuse cookies before using this website, with the drawback
                    that certain features may not function properly without the
                    aid of cookies.
                </p>
                <p className="mt-5">
                    By continuing to navigate our website without changing your
                    cookie settings, you hereby acknowledge and agree to our use
                    of cookies.
                </p>

                <h1 className="font-bold text-3xl mt-10 mb-5">E-commerce</h1>
                <p className="mt-5">
                    Those who engage in transactions with us - by purchasing our
                ...
                <p className="mt-5">
                    ...
                    necessary or appropriate to fulfil the purpose of the
                    visitor&quot;s interaction with this site.
                </p>

                <p className="mt-5">
                    We do not disclose personally-identifying information other
                ...
                <p className="mt-5">
                    ...
                    providing the Sites and services. We may also sell certain
                    assets associated with the Sites. As a result, please be
                    aware that in such event we may transfer some or all of your
                    information to a company acquiring all or part of our assets
                    or to another company with which we have merged.
                </p>

                <p className="mt-5">
                    Under such circumstances we would, to the extent possible,
                    require the acquiring party to follow the practices
                    described in this Privacy Policy, as it may be amended from
                    time to time. Nevertheless, we cannot promise that an
                    acquiring company or the merged company will have the same
                    privacy practices or treat your information the same as
                ...
                <p className="mt-5">
                    ...
                    please contact us by clicking the contact link on the bottom
                    this page.
                </p>
