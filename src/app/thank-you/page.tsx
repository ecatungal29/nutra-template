                ...
                <div className="flex p-5 md:p-20 flex-col items-center md:flex-row md:w-full bg-gray-100">
                    ...
                    <div className="flex flex-col justify-between p-4 leading-normal md:px-20 w-full md:w-7/12">
                        ...
                        <p className="mt-5 mb-2 font-normal text-center md:text-left">
                            Your credit card will show a charge from Digistore
                            24, a retailer of products on this site.
                        </p>

                        <p className="mt-5 mb-2 font-normal text-center md:text-left">
                            We strive to ship every order in 48 hours or less
                            and you will receive a shipment notification from
                            Digistore 24 as soon as that happens.
                        </p>

                        <p className="mt-5 mb-2 font-normal text-center md:text-left">
                            Please allow 3-5 business days for US shipping and
                            7-14 days for international shipping (sometimes
                            there are COVID-related delays when crossing
                        ...
                        <div className="mt-10">
                            <p className="font-bold">
                                Craig Shultz Creator, ProstaFlow
                            </p>
                        </div>
                        <div className="">
                            <Image
