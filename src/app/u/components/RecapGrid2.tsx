...
export default function RecapGridTwo() {
    return (
        <div className="w-11/12 md:w-9/12 mx-auto mt-10 md:mt-20 bg-[#1e103e] border rounded-3xl p-5 shadow md:p-20 max-w-screen-xl">
            <div className="w-full md:w-12/12 mx-auto  mb-5">
                <h1 className="p-5  md:p-0 md:mb-10 text-center text-3xl md:text-[28px] text-white font-bold">
