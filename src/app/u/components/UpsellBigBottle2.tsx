    ...
    <>
      <div className='w-11/12 md:w-9/12 mx-auto mb-32 mt-20 bg-gray-300 border rounded-3xl shadow'>
        <div className='w-full'>
          <h1 className='p-5 md:p-0 mt-10 text-center text-3xl md:text-4xl font-bold'>
        ...
        <div className="mx-auto flex p-5 items-center flex-col md:flex-row">
          <div className="flex flex-col justify-between p-4 leading-normal md:w-6/12">
            <h5 className="text-center text-3xl md:text-5xl font-bold">
              6 BOTTLES FOR JUST <del>$414</del> <span className="text-red-600">$198!</span>
            </h5>

            <p className="text-center mt-5 mb-2 font-normal text-xl">
              Add an Additional 6 BOTTLES at The Outrageous Discount of Just <del>$69</del> $33 per bottle!
            </p>
        ...
        <div className='w-full'>
          ...
          <div className='w-8/12 mx-auto p-3'>
            <Link href="/">
              <p className='text-base mt-1 underline text-center justify-center'>
                Yes, I&lsquo;d like to experience balanced blood sugar levels and boast sky-high energy. Upgrade my order with the biggest discount.
              </p>
            </Link>
          </div>
          ...
          <div className='w-8/12 mx-auto p-3 mb-8'>
            <p onClick={() => handleClick(true)} className=' hover:cursor-pointer hover:text-blue-600 text-sm underline text-center justify-center text-gray-500'>
              No Thanks, I&lsquo;ll Miss Out On This Incredible Upgrade. I Understand That When I Order More ProstaFlow,
              This One-Time-Only Discount And The Bonuses Will No Longer Be Available.
            </p>
          </div>
        </div>
      </div>
