...
export default function UpsellProtectedTwo() {
    return (
        <>
            <div className="mx-auto flex justify-center p-5 md:p-0 max-w-screen-xl">
                <div className="p-10 items-center bg-gradient-to-t from-[#384364] to-[#29314A] border rounded-3xl md:w-9/12">
                    ...
                    <div className="md:p-5 md:w-10/12 mx-auto">
                        ...
                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            ...
                            So you have nothing to lose and a whole lot of
                            savings to gain today!
                        </p>

                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            I demand that you are ecstatic about your purchase,
                            not just satisfied. That&apos;s why ProstaFlow is
                            fully guaranteed for 60 days from the date of your
                            purchase.
                        </p>
                        ...
                        <p className="text-center mb-3 font-normal text-gray-200 mt-5">
                            *96% Of Customers Order 3 Bottles (Our Recommended
                            Option)
                        </p>
