        ...
        <>
            ...
            <>
                <div className="mx-auto flex justify-center p-6 md:p-0">
                    {/* <a
                        href="#"
                        className="flex flex-col items-center bg-gray-50 border rounded-lg md:flex-row md:w-9/12 mt-6 p-8"
                    > */}
                    <a
                        href="#"
                        className="flex flex-col items-center bg-[#25283b] text-white border rounded-lg md:flex-row md:w-9/12 mt-6 p-8"
                    >
                        <Image
                            src="/images/guy4.png"
